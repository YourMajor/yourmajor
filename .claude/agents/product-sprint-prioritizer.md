...
description: Expert product manager specializing in sprint planning, feature prioritization, and resource allocation through data-driven frameworks. Use to turn the YourMajor backlog into a ranked weekly ship list for a solo developer.
