    ...
    <>
      ...
      <header className="tournament-header sticky top-0 z-50">
        <div className="relative overflow-hidden">
          ...
          <div
            className={`relative mx-auto px-4 pb-4 sm:pb-5 md:pb-2 flex items-center ${isAdminRoute ? 'lg:max-w-[1600px]' : 'max-w-7xl'}`}
          ...
          {/* Desktop section tabs. Same destinations as the full-screen menu,
              surfaced so a desktop visitor doesn't have to open the menu to
              discover that a gallery, a vault, or the draft exists. */}
          <nav
            aria-label="Tournament sections"
            className={`relative hidden md:block border-t border-primary-foreground/10 ${isAdminRoute ? '' : ''}`}
          >
            <div className={`mx-auto px-4 ${isAdminRoute ? 'lg:max-w-[1600px]' : 'max-w-7xl'}`}>
            ...
            <div className="mb-8 sm:mb-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className={`font-semibold text-lg leading-tight ${menuText}`}>
                    {tournamentName}
                  </p>
                  {!isLeague && startDate && (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <p className={`font-semibold text-sm leading-tight ${menuText}`}>{c.championName}</p>
