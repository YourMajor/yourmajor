      ...
      {tournaments.map((t) => {
        ...
        return (
          <Link key={t.id} href={`/${t.slug}`} className="block">
            <Card className="tcard-hover rounded-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 cursor-pointer overflow-hidden !py-0 !gap-0">
              {/* Branded header strip: the curtain (see TournamentCard) */}
              <div className="relative px-3 py-2.5 flex items-center overflow-hidden">
                ...
                <div className="relative flex items-center gap-2.5 min-w-0 flex-1">
                  {t.logo ? (
                    ...
                    <div
                      className="h-9 w-9 sm:h-10 sm:w-10 rounded-full flex items-center justify-center text-base font-semibold text-white shrink-0 border-2"
                  ...
                  <div className="min-w-0">
                    <p className="font-semibold text-white truncate text-sm sm:text-base">{t.name}</p>
