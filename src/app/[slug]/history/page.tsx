...
export default async function HistoryPage({
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      <header>
        <h1 className="text-2xl font-heading">History</h1>
      ...
      <section className="space-y-4">
        <h2 className="font-sans text-base font-semibold">Past Editions</h2>
        {podiums.length === 0 ? (
      ...
      <section className="space-y-4">
        <h2 className="font-sans text-base font-semibold">All-Time Roster</h2>
        <HistoryRosterTable
