      ...
      {organising.length > 0 && (
        <section className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-sans font-semibold text-lg">Organising</h2>
          </div>
          {organising.map((m) => (
            <TournamentCard
              key={m.id}
      ...
      {playing.length > 0 && (
        <section className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-sans font-semibold text-lg">Playing</h2>
          </div>
          {playing.map((m) => (
            <TournamentCard
              key={m.id}
      ...
      {watching.length > 0 && (
        <section className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-sans font-semibold text-lg">Watching</h2>
          </div>
          {watching.map((m) => (
            <TournamentCard
              key={m.id}
